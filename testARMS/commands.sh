...
# Step 0: clean spades
#=================================================================================================
python ~/ARMS/src/ARMS/chewbacca.py -t 2 preclean -f ~/ARMS/data/20K_R1.fq \
-r ~/ARMS/data/20K_R2.fq  -o 0_preclean -j 1

#=================================================================================================
# Step 1: assembling and renaming sequences
#=================================================================================================
python ~/ARMS/src/ARMS/chewbacca.py -t 2 assemble -n BALI -f 0_preclean  -r 0_preclean  -o 1_assembled
...
#======================================================================================
python ~/ARMS/src/ARMS/chewbacca.py -t 2 trim_adapters  -i 2b_renamed -o 3_trim_ab -a ~/ARMS/data/adapters.fasta \
...
## Step 7: run MACSE
##=================================================================================================
python ~/ARMS/src/ARMS/chewbacca.py -t 2 macseAlign -i 6_partitioned -o 7_macseAligned -d ~/ARMS/data/BIOCODETEMPLATE 

##=====================================================================================================
## Step 8: Filter the data to be clustered
##+========================================================================================================
python ~/ARMS/src/ARMS/chewbacca.py -t 2 macseClean -i 7_macseAligned -o 8_macseCleaned -d ~/ARMS/data/BIOCODETEMPLATE -s 6_partitioned

##=================================================================================================
## Step 9: Cluster the sequences
##=================================================================================================
# SWARM
python ~/ARMS/src/ARMS/chewbacca.py -t 2 cluster_seqs -i 8_macseCleaned -o 10_clustered -g 5_derep_groups_files

# CROP
# python ~/ARMS/src/ARMS/chewbacca.py -t 2 cluster_seqs -i 8_macseCleaned -o 10_clustered -g 5_derep_groups_files -p crop -z 50 -b 173

# Vsearch
# python ~/ARMS/src/ARMS/chewbacca.py -t 2 cluster_seqs -i 8_macseCleaned -o 10_clustered -g 5_derep_groups_files -p vsearch


##=================================================================================================
## Step 10: Build the abundance matrix
##=================================================================================================
python ~/ARMS/src/ARMS/chewbacca.py build_matrix -b ~/ARMS/data/barcodes.txt -g 10_clustered_groups_files -s 2b_renamed_samples -o 11_buildmatrix
...
##=================================================================================================
python ~/ARMS/src/ARMS/chewbacca.py annotate_matrix -i 11_buildmatrix -a 12_biocode -o 15_annotate_biocode
python ~/ARMS/src/ARMS/chewbacca.py annotate_matrix -i 15_annotate_biocode -a 13_bold -o 16_annotate_bold
python ~/ARMS/src/ARMS/chewbacca.py annotate_matrix -i 16_annotate_bold -a 14_ncbi -o 17_annotate_ncbi

##=================================================================================================
## Step 13: Visualize the data
##=================================================================================================
python ~/ARMS/src/ARMS/chewbacca.py visualize_otu_sample_composition -i 11_buildmatrix -o 18_otu_sample_comp
python ~/ARMS/src/ARMS/chewbacca.py visualize_otu_heatmap -i 11_buildmatrix -o 19_otu_heatmap
